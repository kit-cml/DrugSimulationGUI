...
static constexpr auto qt_meta_stringdata_ZN12BrowseWidgetE = QtMocHelpers::stringData(
    "BrowseWidget",
    "browse_file",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN12BrowseWidgetE[] = {
...
Q_CONSTINIT const QMetaObject BrowseWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN12BrowseWidgetE.offsetsAndSizes,
    qt_meta_data_ZN12BrowseWidgetE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN12BrowseWidgetE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<BrowseWidget, std::true_type>,
        // method 'browse_file'
...
void *BrowseWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN12BrowseWidgetE.stringdata0))
